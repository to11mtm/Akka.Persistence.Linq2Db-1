...
namespace Akka.Persistence.Linq2Db.BenchmarkTests.Docker.SqlCommon
{
    ...
    public class DockerSqlCommonOracleXeJournalPerfSpec : L2dbJournalPerfSpec
    {
        ...
        public static Config Create(string connString)
        {
            return ConfigurationFactory.ParseString(
                string.Format(_journalBaseConfig,
                    typeof(Akka.Persistence.Oracle.Journal.OracleJournal).AssemblyQualifiedName,
                    connString,"testPerfTable"));
        }
        public DockerSqlCommonOracleXeJournalPerfSpec(ITestOutputHelper output,
